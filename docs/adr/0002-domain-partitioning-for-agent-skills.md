...
We have mapped all 13 agent skills into the seven bounded domains defined in `CONTEXT-MAP.md` and expanded the ubiquitous language glossaries in `docs/domains/*/CONTEXT.md`:
...
5. **Integration & I/O**: `repo-to-plugin-forge` (automated plugin synthesis from attached repositories), `book-to-skill-forge` (skill synthesis from books, articles, and video transcripts).
